...
static char *font2[] = { "Font Awesome 5 Free Regular:pixelsize=16:antialias=true:autohint=true", "Font Awesome 5 Free Solid:pixelsize=16:antialias=true:autohint=true" };
